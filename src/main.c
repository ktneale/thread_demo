...
{
    fprintf(stdout,
	    "Thread Test Application.  Written by Kevin Neale (c) 2015\n");
}
...
void usage()
{
    ...
    fprintf(stderr,
	    "     -d <debug_level>   - Level of debug to display (all, info, warning, major, critical, none).\n");
    fprintf(stderr,
	    "     -v                 - Application version info.\n");
}
...
int main(int argc, char **argv)
{
    ...
    while (1) {
	    ...
	    //Test to see if the worker thread is still responsive.
